...
export const emailContents = {
    en: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />Thank you for completing all questions for the upcoming Citizenship Day ${year} event. Unfortunately, your case appears too complex and we will give priority to those who have qualified. Your phone information will be given to our staff and they will contact you by phone first. Our staff will attempt to contact you two times. You may receive a call in the first half of June ${year}. We expect many applicants, so it may take one week or more before you receive a call
If you do not wish to wait, please visit <a href="https://www.e-immigrate.info/partners/santa-clara-county-immigration-legal-services-referral-list/">SANTA CLARA COUNTY IMMIGRATION LEGAL SERVICES LIST</a>, select an agency and contact them to make an appointment - the services you choose may not be free and are not part of Citizenship Day ${year} event.
...
`,
    ...
    es: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />Gracias por completar todas las preguntas para el Día de la Ciudadanía del ${year}. Desafortunadamente, su caso parece demasiado complejo y le daremos prioridad a los que calificaron. Su información será compartida con nuestro personal y ellos intentarán comunicarse por teléfono con usted dos veces.
<br /><br />Es posible que reciba una llamada durante las primeras dos semanas de junio del ${year}. Esperamos muchos solicitantes, por lo que puede tomar hasta una semana antes de recibir una llamada.
<br /><br />Si no desea esperar, visite, <a href="http://bit.ly/SCCreferralSPANISH" >http://bit.ly/SCCreferralSPANISH</a>, seleccione una agencia y comuníquese con ellos para programar una cita; es posible que los servicios que elija tengan algún costo y no forman parte del evento, Día de la Ciudadanía del ${year}.
...
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />Gracias por completar todas las preguntas para el evento, Día de la Ciudadanía del ${year}. ¡Felicitaciones, has calificado para participar! No hay una dirección física para este evento. Primero, nos comunicaremos con usted por teléfono. Nuestro personal intentará comunicarse con usted dos veces. Nuestro personal le dará instrucciones sobre lo que debe hacer. Comenzaremos a llamar a todos los candidatos calificados a partir del lunes 16 de mayo. Esperamos muchos solicitantes, por lo que puede tomar hasta una semana antes de recibir una llamada.
...
`,
    ...
    vi: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />Không đủ điều kiện cho các dịch vụ<br /><br />
        Cảm ơn bạn đã hoàn thành tất cả các câu hỏi cho Ngày nhập tịch ${year} sắp tới. Rất tiếc, trường hợp của bạn có vẻ quá phức tạp và chúng tôi sẽ ưu tiên những người đủ điều kiện. Thông tin điện thoại của bạn sẽ được cung cấp cho nhân viên của chúng tôi và họ sẽ liên hệ với bạn qua điện thoại trước. Nhân viên của chúng tôi sẽ cố gắng liên hệ với bạn hai lần. Bạn có thể nhận được cuộc gọi vào nửa đầu tháng 6 năm ${year}. Sẽ có nhiều người nộp đơn, vì vậy có thể mất một tuần trước khi bạn nhận được cuộc gọi.
<br /><br />
Nếu bạn không muốn đợi, vui lòng truy cập <a href="http://bit.ly/SCCreferralVIETNAMESE" >http://bit.ly/SCCreferralVIETNAMESE</a>, chọn một cơ quan và liên hệ với họ để đặt lịch hẹn - các dịch vụ bạn chọn có thể không miễn phí và không nằm trong Ngày Nhập tịch năm ${year}.
...
`,
    ...
    // Mandarin
    cmn: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />谢谢您回答有关即将举行的2022年公民日活动的问卷里所有的问题。不好意思，您的个案看来太复杂。我们会优先处理那些符合资格的人士。您的电话号码会交给我们的员工，他们将会先打电话和您联系。我们的员工会尝试两次和您联络。您可能在2022年6月上半月收到电话。我们期待会有很多申请人，所以您有可能需时至少一周才能收到我们的电话。
...
新公民计划 敬上
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />谢谢您回答有关即将举行的2022年公民日活动的问卷里所有的问题。恭喜您！您有资格参与此活动。这项活动是没有实际地址的。我们将会先打电话和您联系。我们的员工会尝试两次和您联络。我们的员工会给您指示，告诉您您需要做的事情。我们会从5月16日星期一开始打电话给所有符合资格的人士。我们期待会有很多申请人，所以您有可能需时至少一周才能收到我们的电话。
<br /><br />
由于名额有限，我们不能够保证您将会获得服务。
<br /><br />
谢谢您的合作，耐心，和谅解。
...
`,
    ...
    // Korean
    kor: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />다가오는 2022년 시민의 날 행사에 대한 모든 질문을 완료해 주셔서 감사합니다. 유감스럽게도 귀하의 사건은 너무 복잡해 보이며, 우리는 자격이 있는 사람들에게 우선권을 줄 것입니다. 당신의 전화 정보는 우리 직원에게 전달될 것이고, 그들은 먼저 전화로 당신에게 연락할 것입니다. 우리 직원이 당신에게 두 번 연락을 시도할 것입니다. 2022년 6월 상반기에 전화를 받으실 수 있습니다. 신청자가 많을 것으로 예상되므로, 전화를 받기까지 1주일 정도 걸릴 수 있습니다.
...
신규 시민 프로젝트
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />다가오는 ${year} 시민권의 날 행사에 대한 모든 질문을 완료해 주셔서 감사합니다. 축하합니다, 참가 자격이 있습니다! 이 이벤트에 대한 실제 주소가 없습니다. 저희가 먼저 전화로 연락 드리겠습니다. 저희 직원이 두 번 연락을 드릴 것 입니다. 저희 직원이 당신이 해야 할 일에 대한 지시를 해 드릴것 입니다. 우리는 5월 16일 월요일부터 모든 자격을 갖춘 후보자에게 전화를 걸 것입니다. 신청자가 많을것으로 예상되므로,  전화를 받기까지 1주일 정도 걸릴 수 있습니다. 
...
`,
    ...
    tl: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />Salamat po sa pagkumpleto ng lahat ng mga katanungan para sa darating na kaganapang Araw ng Pagkamamayan ${year}. Sa kasamaang palad, ang iyong kaso ay masyadong kumplikado. Binibigyan po namin ng priyoridad ang mga may kwalipikado aplikante. Ibibigay po namin ang inyong telepono sa aming staff para makipag-ugnay sila sa inyo sa telepono. 
<br />Susubukan po ng aming mga staff na makipag-ugnay sa iyo ng dalawang beses. Maaari po kayong makatanggap ng isang tawag sa ika-dalawang linggo Hunyo ${year}. Inaasahan po namin na maraming mga aplikante, kaya't maaaring tumagal ng hanggang isang linggo bago kayo makatanggap ng tawag.
<br /><br />
Kung hindi po ninyong nais na maghintay, mangyaring bisitahin po ninyo ang <a href="http://bit.ly/SCCreferralTAGALOG">http://bit.ly/SCCreferralTAGALOG</a>. Pumili kayo ng isang ahensya at makipag-ugnay po sa kanila upang gumawa ng isang appointment - ang mga serbisyong pinili ninyo ay maaaring hindi libre at hindi bahagi ng Citizenship Day ${year} event.
<br /><br />
...
`,
    ...
    am: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />መስፈርቱን ያላሟሉና በዚህ መርሃ ግብር መሳተፍ የማይችሉ ሰዎች (ቀይ ነጥብ)
...
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />መስፈርቱን አሟልተው አገልግሎቱን ለማግኘት ብቁ የሆኑ ሰዎች (አረንጓዴ ነጥብ)
...
<br /><br />የአዲስ ዜጎች ፕሮጀክት`,
    ...
    hi: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />सेवाओं के लिए योग्य नहीं (रेड-डॉट)
<br /><br />
आगामी नागरिकता दिवस ${year} कार्यक्रम के लिए सभी प्रश्नों को पूरा करने के लिए धन्यवाद। दुर्भाग्य से, आपका मामला बहुत जटिल है और हम उन लोगों को प्राथमिकता देंगे जो योग्य हैं। आपके फोन की जानकारी हमारे कर्मचारियों को दी जाएगी और वे पहले आपसे फोन पर संपर्क करेंगे। हमारे कर्मचारी आपसे दो बार संपर्क करने का प्रयास करेंगे। आपको जून ${year} की पहली छमाही में एक कॉल प्राप्त हो सकती है। हम कई आवेदकों से अपेक्षा करते हैं, इसलिए आपको कॉल प्राप्त करने में एक सप्ताह तक का समय लग सकता है।
<br /><br />
यदि आप इंतजार नहीं करना चाहते हैं, तो कृपया सांता क्लारा काउंटी <a href="http://bit.ly/SCCreferralHINDI">http://bit.ly/SCCreferralHINDI</a> पर जाएं, एक एजेंसी का चयन करें और समय निर्धारित   करने के लिए उनसे संपर्क करें - आपके द्वारा चुनी गई सेवाएं मुफ्त नहीं हो सकती हैं और नागरिक दिवस ${year} event का हिस्सा नहीं हैं।
<br /><br />
...
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />सेवाओं के लिए योग्य (हरा-डॉट)
<br /><br />
...
`,
    ...
    pan: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />ਸੇਵਾਵਾਂ ਲਈ ਯੋਗ ਨਹੀਂ (ਲਾਲ  ਬਿੰਦੀ)
 <br /><br />ਆਉਣ ਵਾਲੇ ਸਿਟੀਜ਼ਨਸ਼ਿਪ ਡੇ ${year} ਸਮਾਗਮ ਲਈ ਸਾਰੇ ਪ੍ਰਸ਼ਨਾਂ ਨੂੰ ਪੂਰਾ ਕਰਨ ਲਈ ਤੁਹਾਡਾ ਧੰਨਵਾਦ।  ਬਦਕਿਸਮਤੀ ਨਾਲ, ਤੁਹਾਡਾ ਕੇਸ ਬਹੁਤ ਗੁੰਝਲਦਾਰ ਜਾਪਦਾ ਹੈ ਅਤੇ ਪਹਿਲਾਂ ਅਸੀਂ ਉਨ੍ਹਾਂ ਨੂੰ ਤਰਜੀਹ ਦੇਵਾਂਗੇ ਜਿਨ੍ਹਾਂ ਨੇ ਯੋਗਤਾ ਪੂਰੀ ਕੀਤੀ ਹੈ।  ਤੁਹਾਡੇ ਫੋਨ ਦੀ ਜਾਣਕਾਰੀ ਸਾਡੇ ਸਟਾਫ ਨੂੰ ਦਿੱਤੀ ਜਾਵੇਗੀ ਅਤੇ ਉਹ ਪਹਿਲਾਂ ਤੁਹਾਡੇ ਨਾਲ ਫੋਨ ਰਾਹੀਂ ਸੰਪਰਕ ਕਰਨਗੇ।  ਸਾਡਾ ਸਟਾਫ ਤੁਹਾਡੇ ਨਾਲ ਦੋ ਵਾਰ ਸੰਪਰਕ ਕਰਨ ਦੀ ਕੋਸ਼ਿਸ਼ ਕਰੇਗਾ।  ਤੁਸੀਂ ਜੂਨ ${year} ਦੇ ਪਹਿਲੇ ਅੱਧ ਵਿੱਚ ਇੱਕ ਕਾਲ ਪ੍ਰਾਪਤ ਕਰ ਸਕਦੇ ਹੋ।  ਅਸੀਂ ਬਹੁਤ ਸਾਰੇ ਬਿਨੈਕਾਰਾਂ ਦੀ ਉਮੀਦ ਕਰਦੇ ਹਾਂ, ਇਸ ਲਈ ਤੁਹਾਡੇ ਦੁਆਰਾ ਇੱਕ ਕਾਲ ਪ੍ਰਾਪਤ ਹੋਣ ਵਿੱਚ ਇੱਕ ਹਫਤਾ ਲੱਗ ਸਕਦਾ ਹੈ.
ਜੇ ਤੁਸੀਂ ਇੰਤਜ਼ਾਰ ਨਹੀਂ ਕਰਨਾ ਚਾਹੁੰਦੇ, ਤਾਂ ਕਿਰਪਾ ਕਰਕੇ <a href="http://bit.ly/SCCreferralPUNJABI">http://bit.ly/SCCreferralPUNJABI</a> ਵੇਖੋ, ਕਿਸੇ ਏਜੰਸੀ ਦੀ ਚੋਣ ਕਰੋ ਅਤੇ ਉਨ੍ਹਾਂ ਨਾਲ ਮੁਲਾਕਾਤ ਕਰਨ ਲਈ ਸੰਪਰਕ ਕਰੋ - ਜਿਹੜੀਆਂ ਸੇਵਾਵਾਂ ਤੁਸੀਂ ਚੁਣਦੇ ਹੋ ਉਹ ਮੁਫਤ ਨਹੀਂ ਹੋ ਸਕਦੀਆਂ ਅਤੇ ਨਾਗਰਿਕਤਾ ਦਿਵਸ ${year} ਦੇ ਹਿਸੇ ਦਾ ਹਿੱਸਾ ਨਹੀਂ ਹਨ। 
 <br /><br />
...
`,
    ...
    pt: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />Obrigado por responder a todas as perguntas para o evento Dia da Cidadania ${year}.
<br /><br />
...
Espere receber nossa ligação na primeira quinzena de Junho de ${year}. Como teremos muitos candidatos, poderá demorar um pouco mais  até que voce receba nossa ligação.
<br /><br />
Se não quiser esperar, visite a <a href="http://bit.ly/SCCreferralPORTUGUESE">http://bit.ly/SCCreferralPORTUGUESE</a>, e entre em contato com alguma  das agencias listadas neste website. Os serviços destas agências poderão não ser gratuitos e não fazem parte do evento Dia da Cidadania ${year}.
<br /><br />
...
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />Obrigado por responder a todas as perguntas para o evento Dia da Cidadania ${year}. 
...
`,
    ...
    fa: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />کسانی که واجد شرایط نیستند (گروه قرمز)
<br /><br />

از اینکه به کلیه ی سوالات Citizenship Day ${year} پاسخ دادید سپاسگزاریم. متاسفانه پرونده ی شما پیچیده است و ما اولویت را به آنهایی میدهیم که پرونده ی ساده ای دارند. شماره ی تماس شما به کارمندان ما داده خواهد شد و نخست تلاش خواهند کرد تا با شما تماس تلفنی بگیرند. آنها سعی خواهند کرد دو بار با شما تماس بگیرند. احتمالا نیمه ی اول ماه ژوئن سال ۲۰۲۲ با شما تماس می گیریم. بدلیل تعداد بالای متقاضیان ممکن است تماس ما با شما تا یک هفته به طول بینجامد. 
<br /><br />

چنانچه تمایلی به صبر کردن ندارید لطفا http://bit.ly/SCCreferralFARSI را مطالعه کرده و با یکی از سازمانهای موجود برای تعیین وقت مشاوره تماس بگیرید. ممکن است خدماتی که احتیاج دارید بخشی از برنامه ی Citizenship Day ${year} نبوده و رایگان نباشند.<br /><br />
<br /><br />
...
`,
    ...
    ti: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />`,
    },
    ar: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />شكرا لكم لاتمامكم جميع الأسئلة عن يوم المواطنة ${year}. مع الاسف فان وضعكم معقد جدا ولذا سوف نعطي الأولوية للذين تأهلوا للمشاركة. وسوف نعطي معلومات تلفونكم لموظفينا وسوف يتصلوا عليك بالتلفون اولا. وسوف يحاول موظفينا الاتصال بك مرتين. وربما يتم الاتصال بكم فى للمرة الاولى في النصف الأول من شهر حزيران ${year}. ونتوقع الكثير من الطلبات ولذلك ربما تأخذ أسبوعا قبل الاتصال 
        <br /><br />
ك.  
وإذا كنت لا ترغب في الانتظار، من فضلك ادخل على موقع http://bit.ly/SCCreferralARABIC وهناك اختار وكالة واتصل بهم لعمل موعد، وان الخدمات التي تطلبها ربما لا تكون مجانية وهي ليس جزأ من يوم المواطنة ${year}. 
<br /><br />
...
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />شكرا لكم لاتمامكم جميع الاسئلة ليوم المواطنة القادم لسنة ${year}. تهانينا انت الان مؤهل للمشاركة، لا يوجد عنوان جغرافي محدد لهذا الحدث. نتصل عليكم بالتلفون في البداية. سيتصل بك  موظفينا مرتين. وسيعطي موظفينا تعليمات لكم حول ما يجب عليك عمله. وسوف نبدأ بالاتصال بكل المرشحين المؤهلين بداية من يوم 16 مايو. ونتوقع الكثير من المشاركين، ولذلك ريما تأخذ مسافة اسبوع قبل الاتصال بكم.
<br /><br />
...
`,
    ...
    ps: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />د خدماتو لپاره وړ ندي (سوړ ټکی)<br /><br />
...
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />د خدماتو لپاره وړ (شنه ټکی)م.
        <br /><br />
...
`,
    ...
    ru: {
        red: (uniqueId: string) => `<br />${uniqueId}<br />Благодарим вас за ответы на все вопросы по поводу предстоящего Дня гражданства 2021 года. К сожалению, ваше дело кажется достаточно сложным, и мы в первую очередь будем заниматься теми, кто прошел по конкурсу. Ваш номер телефона будет передан нашим сотрудникам, чтобы они могли связаться с вами. Наши сотрудники попытаются связаться с вами два раза. Вам могут позвонить в первой половине июня 2021 года. Мы ожидаем много заявок, поэтому может пройти неделя, прежде чем вам позвонят.
...
`,
        green: (uniqueId: string) => `<br />${uniqueId}<br />Одобрено (зеленая точка)
        <br /><br />
